<x-app-layout>
    <div class="container px-12 py-8 mx-auto">
        <h3 class="text-2xl font-bold text-gray-900">เเนะนำ สินค้า</h3>
        <div class="h-1 bg-gray-800 w-40"></div>
            ...
            <div class="w-full max-w-sm mx-auto overflow-hidden bg-white rounded-md shadow-md">
                ...
                <div class="px-5 py-3">
                    ...
                    <div class="flex items-center justify-between mb-5">
                        <h3 class="text-gray-700 uppercase">ชื่อสินค้า : {{ $item->name }}</h3></div>
